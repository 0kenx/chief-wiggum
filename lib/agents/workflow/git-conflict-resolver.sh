...
#   Supports coordinated resolution via resolution-plan.md from multi-PR planner.
# REQUIRED_PATHS:
...
agent_init_metadata "workflow.git-conflict-resolver" "Git merge conflict resolver with optional coordination plan support"
